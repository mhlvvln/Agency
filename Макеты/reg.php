  				...
  				<div class="container-fluid text-white">
    				...
    				<div class="d-flex col-3">
						<span class="navbar-text navbar-item text-white">
	    					<a class="text-white text-decoration-none" href="<?=$_SERVER['SERVER_NAME'] . '/auth';?>" href="">Вdход</a>
	  					</span>
  					...
  					<div class="d-flex form-row">
  						<div class="form-group">
					    	<div class="custom-file">
							    <input type="file" accept=".jpg, .jpeg, .png" class="custom-file-input" id="applicant_photo" onchange="changePhoto();" lang="ru">
	...
	<script>
		...
		$("#userBtnReg").on('click', function(e){
			...
			reader.onload = function(event) {
			    ...
			    //console.log(data);
			    fetch(window.location.origin + '/api/create_user.php', {
				    method: 'POST',
				    headers: {
